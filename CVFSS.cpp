...
/*Customized Virtual file system
  g++ Cvsf.cpp -o Myexe.exe
  DILB created successfully
  Marvellous VFS: >help
  Marvellous VFS: >ls   Error:nosuch file
  Marvellous VFS: >man create //(manual page-display )
  Marvellous VFS: >create Demo.txt  3
  Marvellous VFS: >ls
 file name   Inode  Filesize    linkcount
/*-------------------------------------
    Demo.txt    1      0           1
-------------------------------------
Marvellous VFS: >create Hello.txt  4
Marvellous VFS: >ls
/*-------------------------------------
    Demo.txt    1      0       1
    Hello.txt   
---------------------------------------
Marvellous VFS: >man write    (to write something)manualbook type
